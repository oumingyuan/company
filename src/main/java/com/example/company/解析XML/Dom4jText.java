...
public class Dom4jText {
    ...
    public static void main(String[] args) throws DocumentException {
        ...
        try {
            ...
            Document document3 = reader.read("E:\\oes\\oes-bc\\oes-bc-dispatcher\\src\\test\\java\\com\\wondertek\\oes\\bc\\dispatcher\\xml\\beginBc4G-many.xml");
            TreeWalk(document3);
    ...
    public static Document ParsingXML() {
        ...
        try {
            ...
            document = reader.read("E:\\oes\\oes-bc\\oes-bc-dispatcher\\src\\test\\java\\com\\wondertek\\oes\\bc\\dispatcher\\xml\\beginBc4G-many.xml");//指定文件并读取
    ...
    public static void IteratorsXML() {
        ...
        try {
            SAXReader reader = new SAXReader();
            document = reader.read("E:\\oes\\oes-bc\\oes-bc-dispatcher\\src\\test\\java\\com\\wondertek\\oes\\bc\\dispatcher\\xml\\beginBc4G-many.xml");
        } catch (DocumentException e) {
            e.printStackTrace();
        }
...
　　　　　　         selectSingleNode("xpath表达式")，获取一个节点
    ...
    public static void XPathXML() throws DocumentException {
        Document document = null;
        try {
            SAXReader reader = new SAXReader();
            document = reader.read("E:\\oes\\oes-bc\\oes-bc-dispatcher\\src\\test\\java\\com\\wondertek\\oes\\bc\\dispatcher\\xml\\beginBc4G-many.xml");
...
//        xml.getBytes("utf-8");
        ...
        Document document1 = reader1.read(new ByteArrayInputStream(xml.getBytes(StandardCharsets.UTF_8)));//读取xml字符串，注意这里要转成输入流


        @SuppressWarnings("unchecked")
        List<Node> list = document1.selectNodes("//PrdContId");
//        for (Node node : list) {
...
//        }
    ...
    public static void XPathXMLHuTool() {
        Document document = (Document) XmlUtil.readXML(new File("E:\\oes\\oes-bc\\oes-bc-dispatcher\\src\\test\\java\\com\\wondertek\\oes\\bc\\dispatcher\\xml\\beginBc4G-many.xml"));
        List<Node> list = document.selectNodes("//PrdContId");
        for (Node node : list) {
            System.out.println(node);
        }
